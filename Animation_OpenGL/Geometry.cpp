...
void Geo::drawTriangle(GLint x1, GLint y1, GLint x2, GLint y2, GLint x3, GLint y3)
{
...
void Geo::drawRectangle(GLint x1, GLint y1, GLint x2, GLint y2, GLint x3, GLint y3, GLint x4, GLint y4)
{
	glBegin(GL_QUADS);
	glVertex2i(x1, y1);
	glVertex2i(x2, y2);
